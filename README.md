...
- Son olarak
  ...
  npm run dev
  ```
  Artık tarayıcımızdan "http://localhost:5173/" adresine bağlanarak sayfamızı görebiliriz. :rocket:
...
- Finally, run
  ...
  npm run dev
  ```
  Now we may reach our webpage at "http://localhost:5173/" in our browser. :rocket:
